...
<div class="mb-6">
    <div class="flex justify-between items-center">
        <div>
            <h2 class="text-2xl font-bold text-gray-800">Add New Testimonial</h2>
            <p class="text-gray-600">Create a new testimonial from a client</p>
        </div>
    ...
    <form action="{{ route('admin.testimonials.store') }}" method="POST">
        ...
        <div class="mb-6">
            ...
            <textarea name="text" id="text" rows="5" 
                      class="w-full border border-gray-300 rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500" required>{{ old('text') }}</textarea>
        </div>
